...
%    LAGRANGE(X,POINTX,POINTY,2) computes the derivative at X by finding the solution at X,
%    then re-running with option 1 to find the derivative there.  This is numerically unstable 
%    for small step size of X and should not be trusted at tails of the data set. 
%    However, it can be more accurate than option 1. 
%
%    NOTE: When dealing with lots of control points, this algorithm works best by buffering the 
%    interpolation period with more control points outside that epoch.  However, the more control points, 
