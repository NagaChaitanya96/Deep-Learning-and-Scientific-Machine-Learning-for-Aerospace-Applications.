...
@named pde_system = PDESystem(eqn,bcs,domains,indvars,depvars)
n = 10
...
discretization = PhysicsInformedNN(chain,grid_strategy,param_estim = false, additional_loss = nothing)
