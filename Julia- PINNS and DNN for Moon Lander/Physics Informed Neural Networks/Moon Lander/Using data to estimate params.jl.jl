...
#plot(p1,p2,plot_title = "Using Sigmoid Function with data")
p = res.minimizer[end-2:end]
println("p",p)
plot(p1,p2,plot_title = "Using Sigmoid Function with data")

#png("D:\\Chaitanya\\sciml\\Analysis so far\\ Using Data to estimate parameters for mechanistic models")
# params obtained are as below substituted
plot(vcat([-0.5277/(1+exp(-(-30.7176)*t -41.5412)) for t in t_]...))
