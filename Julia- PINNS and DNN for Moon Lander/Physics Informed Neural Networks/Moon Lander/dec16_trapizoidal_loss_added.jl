...
function ThrustLossfunc(phi,θ,p)
      ...
      # This gives us the approx value of u within 0 and 3 as we imposed hard constraints. So now we can minimize the interval
      # values by giving the Trapizoidal loss function.
